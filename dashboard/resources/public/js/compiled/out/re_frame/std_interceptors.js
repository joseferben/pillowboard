...
var vec__21267_21270 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_21271 = cljs.core.nth.call(null,vec__21267_21270,(0),null);
var only_after_21272 = cljs.core.nth.call(null,vec__21267_21270,(1),null);
var db_changed_QMARK__21273 = (!((only_before_21271 == null))) || (!((only_after_21272 == null)));
if(db_changed_QMARK__21273){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_21271);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_21272);
...
var map__21274 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__21274__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__21274__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__21276 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__21276__$1;
var event = cljs.core.get.call(null,map__21276__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8889__auto___21279 = arguments.length;
var i__8890__auto___21280 = (0);
while(true){
if((i__8890__auto___21280 < len__8889__auto___21279)){
args__8896__auto__.push((arguments[i__8890__auto___21280]));

var G__21281 = (i__8890__auto___21280 + (1));
i__8890__auto___21280 = G__21281;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__8897__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq21278){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21278));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__7610__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__8896__auto__ = [];
var len__8889__auto___21287 = arguments.length;
var i__8890__auto___21288 = (0);
while(true){
if((i__8890__auto___21288 < len__8889__auto___21287)){
args__8896__auto__.push((arguments[i__8890__auto___21288]));

var G__21289 = (i__8890__auto___21288 + (1));
i__8890__auto___21288 = G__21289;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8897__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__21282_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__21283_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__21283_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__7598__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq21284){
var G__21285 = cljs.core.first.call(null,seq21284);
var seq21284__$1 = cljs.core.next.call(null,seq21284);
var G__21286 = cljs.core.first.call(null,seq21284__$1);
var seq21284__$2 = cljs.core.next.call(null,seq21284__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__21285,G__21286,seq21284__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1513171809782
