...
var G__25026 = devtools.prefs.pref.call(null,v);
v = G__25026;
continue;
} else {
return v;
...
var and__7598__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7598__auto__){
var and__7598__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7610__auto__ = (function (){try{if(!((value == null))){
...
}catch (e25029){var _e__9894__auto__ = e25029;
return false;
}})();
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
var or__7610__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e25033){var _e__9894__auto__ = e25033;
return false;
}})();
...
}catch (e25035){var _e__9894__auto__ = e25035;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7598__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7598__auto__)){
var and__7598__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7598__auto____$1){
...
var and__7598__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7598__auto__)){
...
var or__7610__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
var and__7598__auto__ = (function (){var or__7610__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
var vec__25037 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25037,(0),null);
var name = cljs.core.nth.call(null,vec__25037,(1),null);
...
var and__7598__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7598__auto__)){
...
var or__7610__auto__ = typeof value === 'string';
if(or__7610__auto__){
return or__7610__auto__;
} else {
var or__7610__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__25040_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25040_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1513171813856
