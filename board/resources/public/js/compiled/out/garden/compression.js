 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__20547){
var vec__20548 = p__20547;
var tag = cljs.core.nth.call(null,vec__20548,(0),null);
var re = cljs.core.nth.call(null,vec__20548,(1),null);
return ((function (vec__20548,tag,re){
return (function (s){
...
var len__8889__auto___20553 = arguments.length;
var i__8890__auto___20554 = (0);
while(true){
if((i__8890__auto___20554 < len__8889__auto___20553)){
args__8896__auto__.push((arguments[i__8890__auto___20554]));

var G__20555 = (i__8890__auto___20554 + (1));
i__8890__auto___20554 = G__20555;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__8897__auto__);
});
...
return p1__20551_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq20552){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20552));
});
...
var map__20556 = temp__5276__auto__;
...
var tag = cljs.core.get.call(null,map__20556__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__20556__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__20556__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__20559 = cljs.core.subs.call(null,s1,size);
var G__20560 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__20558 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1513171809214
