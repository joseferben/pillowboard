...
var or__33894__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj58139 = {"detail":data};
return obj58139;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__33882__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__33882__auto__)){
var and__33882__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__58146 = cljs.core._EQ_;
var expr__58147 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__58146.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__58147))){
return ((function (pred__58146,expr__58147){
return (function (p1__58140_SHARP_){
return console.warn(p1__58140_SHARP_);
});
;})(pred__58146,expr__58147))
} else {
if(cljs.core.truth_(pred__58146.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__58147))){
return ((function (pred__58146,expr__58147){
return (function (p1__58141_SHARP_){
return console.debug(p1__58141_SHARP_);
});
;})(pred__58146,expr__58147))
} else {
if(cljs.core.truth_(pred__58146.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__58147))){
return ((function (pred__58146,expr__58147){
return (function (p1__58142_SHARP_){
return console.error(p1__58142_SHARP_);
});
;})(pred__58146,expr__58147))
} else {
return ((function (pred__58146,expr__58147){
return (function (p1__58143_SHARP_){
return console.log(p1__58143_SHARP_);
});
;})(pred__58146,expr__58147))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__58150){
var map__58151 = p__58150;
var map__58151__$1 = ((((!((map__58151 == null)))?((((map__58151.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58151.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58151):map__58151);
var opts = map__58151__$1;
var eval_fn = cljs.core.get.call(null,map__58151__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__58153_SHARP_);
});})(new_def))
);
...
return (function (p__58154){
var vec__58155 = p__58154;
var ky = cljs.core.nth.call(null,vec__58155,(0),null);
var v = cljs.core.nth.call(null,vec__58155,(1),null);
...
if(cljs.core.truth_((function (){var and__33882__auto__ = typeof localStorage !== 'undefined';
...
}catch (e58160){if((e58160 instanceof Error)){
var e = e58160;
return not_found;
} else {
throw e58160;
...
//# sourceMappingURL=utils.js.map?rel=1513172446020
