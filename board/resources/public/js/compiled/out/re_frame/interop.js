...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__11852 = cljs.core.instance_QMARK_;
var expr__11853 = reactive_val;
if(cljs.core.truth_(pred__11852.call(null,reagent.ratom.RAtom,expr__11853))){
return "ra";
} else {
if(cljs.core.truth_(pred__11852.call(null,reagent.ratom.RCursor,expr__11853))){
return "rc";
} else {
if(cljs.core.truth_(pred__11852.call(null,reagent.ratom.Reaction,expr__11853))){
return "rx";
} else {
if(cljs.core.truth_(pred__11852.call(null,reagent.ratom.Track,expr__11853))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1513171801749
