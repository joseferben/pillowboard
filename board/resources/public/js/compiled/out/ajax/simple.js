...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__14919){
var map__14920 = p__14919;
var map__14920__$1 = ((((!((map__14920 == null)))?((((map__14920.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14920.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14920):map__14920);
var handler = cljs.core.get.call(null,map__14920__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__7610__auto__ = p1__14922_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__14923){
...
var request = map__14924__$1;
var interceptors = cljs.core.get.call(null,map__14924__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__7610__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1513171805885
