...
var o24924 = temp__5276__auto__;
var temp__5276__auto____$1 = (o24924["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o24925 = temp__5276__auto____$1;
return (o24925["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9887__auto__ = f;
return (o__9887__auto__["toString"]).call(o__9887__auto__);
} else {
return "";
}
}catch (e24926){var _ = e24926;
return "";
}});
...
try{var o__9887__auto___24928 = t;
(o__9887__auto___24928["cljs$lang$ctorPrWriter"]).call(o__9887__auto___24928,t,writer);
}catch (e24927){var __24929 = e24927;
}
...
var char_code = (function (){var o__9887__auto__ = (new String(char$));
return (o__9887__auto__["charCodeAt"]).call(o__9887__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9887__auto__ = String;
return (o__9887__auto__["fromCharCode"]).call(o__9887__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24930 = num_code;
switch (G__24930) {
case (1):
return (185);
...
var o__9887__auto__ = String;
return (o__9887__auto__["fromCharCode"]).call(o__9887__auto__,superscript_code);
});
/**
...
}catch (e24932){var _e__9894__auto__ = e24932;
return false;
}})())){
...
var vec__24933 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24933,(0),null);
...
var or__7610__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o24936 = temp__5276__auto__;
var temp__5276__auto____$1 = (o24936["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o24937 = temp__5276__auto____$1;
return (o24937["nameToPath"]);
} else {
return null;
}
} else {
...
var len__8889__auto___24944 = arguments.length;
var i__8890__auto___24945 = (0);
while(true){
if((i__8890__auto___24945 < len__8889__auto___24944)){
args__8896__auto__.push((arguments[i__8890__auto___24945]));

var G__24946 = (i__8890__auto___24945 + (1));
i__8890__auto___24945 = G__24946;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8897__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24940){
var vec__24941 = p__24940;
var ns_detector = cljs.core.nth.call(null,vec__24941,(0),null);
var effective_detector = (function (){var or__7610__auto__ = ns_detector;
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
var G__24947 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24948 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24947;
remaining_tokens = G__24948;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24938){
var G__24939 = cljs.core.first.call(null,seq24938);
var seq24938__$1 = cljs.core.next.call(null,seq24938);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24939,seq24938__$1);
});
...
var vec__24952 = cljs.core.split_with.call(null,(function (p1__24951_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24951_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24952,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24952,(1),null);
...
var vec__24955 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24955,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24955,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24958 = cljs.core.rest.call(null,remaining_tokens);
var G__24959 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24958;
name_tokens = G__24959;
continue;
} else {
...
var vec__24962 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24962,(0),null);
var arity = cljs.core.nth.call(null,vec__24962,(1),null);
var vec__24965 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24965,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24965,(1),null);
var vec__24968 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24968,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24968,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24968,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24968,(3),null);
...
var vec__24974 = result;
var munged_ns = cljs.core.nth.call(null,vec__24974,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24974,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24974,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24974,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24974,(4),null);
var arity = cljs.core.nth.call(null,vec__24974,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__24978 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__24978,(0),null);
var args = cljs.core.nth.call(null,vec__24978,(1),null);
var vec__24981 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24981,(0),null);
var name = cljs.core.nth.call(null,vec__24981,(1),null);
...
var G__24984 = (arity + (1));
var G__24985 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24986){
var vec__24987 = p__24986;
var arity = cljs.core.nth.call(null,vec__24987,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24987,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__7610__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__24990_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24991_SHARP_);
...
var args__8896__auto__ = [];
var len__8889__auto___24998 = arguments.length;
var i__8890__auto___24999 = (0);
while(true){
if((i__8890__auto___24999 < len__8889__auto___24998)){
args__8896__auto__.push((arguments[i__8890__auto___24999]));

var G__25000 = (i__8890__auto___24999 + (1));
i__8890__auto___24999 = G__25000;
continue;
} else {
}
break;
...
var argseq__8897__auto__ = ((((1) < args__8896__auto__.length))?(new cljs.core.IndexedSeq(args__8896__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8897__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24994){
var vec__24995 = p__24994;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24995,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24992){
var G__24993 = cljs.core.first.call(null,seq24992);
var seq24992__$1 = cljs.core.next.call(null,seq24992);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24993,seq24992__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__7610__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__7598__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__7610__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25003__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25003__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25003__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25003__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25004 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25004,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25004,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25004,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25004,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25004,(4),null);
var arity = cljs.core.nth.call(null,vec__25004,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__7598__auto__ = protocol_ns;
if(cljs.core.truth_(and__7598__auto__)){
return cljs.core.not.call(null,(function (){var and__7598__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7610__auto__ = protocol_part;
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
return fn_part;
...
var o__9887__auto__ = f;
return (o__9887__auto__["getBasis"]).call(o__9887__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__7598__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7598__auto__)){
...
}catch (e25008){var _e__9894__auto__ = e25008;
...
var G__25009 = (obj[cljs.core.first.call(null,path)]);
var G__25010 = cljs.core.rest.call(null,path);
obj = G__25009;
path = G__25010;
continue;
} else {
...
var partition_bits = (function (){var or__7610__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
return (0);
...
return (function (accum,p__25011){
var vec__25012 = p__25011;
var bit = cljs.core.nth.call(null,vec__25012,(0),null);
var protocol = cljs.core.nth.call(null,vec__25012,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25015){
...
var selector = cljs.core.nth.call(null,vec__25016,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25021,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25021,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25021,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25019_SHARP_){
return (obj[cljs.core.first.call(null,p1__25019_SHARP_)]);
});})(name,sorted_matches,vec__25021,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513171813805
