...
var len__8889__auto___25055 = arguments.length;
var i__8890__auto___25056 = (0);
while(true){
if((i__8890__auto___25056 < len__8889__auto___25055)){
args__8896__auto__.push((arguments[i__8890__auto___25056]));

var G__25057 = (i__8890__auto___25056 + (1));
i__8890__auto___25056 = G__25057;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8897__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25052){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__25053,G__25054,seq25052__$2);
});
...
if(cljs.core.truth_((function (){var or__7610__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8281__auto__,writer__8282__auto__,opt__8283__auto__){
return cljs.core._write.call(null,writer__8282__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7598__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7598__auto__){
var or__7610__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25058_SHARP_){
return !((cljs.core.meta.call(null,p1__25058_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__25059__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7610__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e25063){var _e__9894__auto__ = e25063;
return false;
}})();
if(cljs.core.truth_(or__7610__auto__)){
return or__7610__auto__;
...
}catch (e25065){var _e__9894__auto__ = e25065;
return false;
}}
})())){
...
var _STAR_current_state_STAR_25067 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__25068 = opts;
...
var markup_db = cljs.core.get.call(null,map__25068__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_25067;
}});
...
;
var temp__5276__auto___25072 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___25072)){
var managed_print_level_25073 = temp__5276__auto___25072;
var _STAR_print_level_STAR_25071_25074 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_25073;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_25071_25074,managed_print_level_25073,temp__5276__auto___25072,writer,opts,job_fn){
return (function (p1__25070_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25070_SHARP_,null);
});})(_STAR_print_level_STAR_25071_25074,managed_print_level_25073,temp__5276__auto___25072,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_25071_25074;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1513171813921
